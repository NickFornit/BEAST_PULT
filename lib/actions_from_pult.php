...
7 => array("Поиграть", "Увеличение потребности в игровом общении - задать контекст игрового общения."),
8 => array("Предложить поучить", "Увеличение потребности учиться - задать контекст обучающего общения."),
...
14 => array("Поощрить", "Поощрить действия Beast, показать сопреживание."),
