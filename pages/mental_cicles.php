...
function get_info() {  
var AJAX = new ajax_support(linking_address + "?get_mental_cickles_list_info=1", sent_get_info);
AJAX.send_reqest();
function sent_get_info(res) { //alert(res);
if(res.length<5)
	{
document.getElementById('rules_info_id').innerHTML = "Еще нет кратковременной памяти.";
	}
