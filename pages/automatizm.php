...
5. Заполнить общий шаблон ответов для имитации отзеркаливания /pages/mirror_basic_phrases_common.php<br>
...
7. Заполнить таблицы для всех сочетаний Базовых контекстов /pages/mirrors_automatizm.php (очень большая работа)<br>
