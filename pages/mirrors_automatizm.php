<?
/* набивальщик базы зеркальных автоматизмов из условных рефлексов (безусловных если нет условных для данных условий)
...
*/
$page_id = -1;
$title = "Создание базы зеркальных автоматизмов из условных рефлексов";
