...
В столбце Эффект 5 пульсов нужно проставить + (позитивный эффект) или - (негативный эффект). Общее позитивное или негативное воздействие при нажатии кнопки держится 5 пульсов. Здесь имеются в виду не Базовые состояния (Плохо или Хорошо) а (де)мотивирующее настроение в ответ на действия Beast.
